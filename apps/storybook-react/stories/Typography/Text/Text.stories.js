  ...
  >
    ...
    <div style={{ margin: '20px 20px' }}>
      <Text size="large" italic={true}>
        Flexasus Typography. Have a good day.{' '}
      </Text>
    </div>
    <div style={{ margin: '20px 20px' }}>
      <Text size="medium" color="seagreen">
        Flexasus Typography. Have a good day.{' '}
      </Text>
    </div>
    <div style={{ margin: '20px 20px' }}>
      <Text size="small" color="red" fontFamily="cursive">
        Flexasus Typography. Have a good day.{' '}
      </Text>
    </div>
    <div style={{ margin: '20px 20px' }}>
      <Text size="small">
        ...
        saw the less he spoke. As he spoke less, he heard more. He heard people
        talking and telling stories. He heard a woman saying that an elephant
        jumped over a fence. He also heard a man saying that he had never made a
        mistake. The old owl had seen and heard about what happened to people.
        Some became better and some became worse. But the old owl had become
      ...
      >
        {' '}
        Moral : You should be observant, talk less but listen more. This will
